...
public class MenuManager {
    ...
    public void afficherMenuEvenements() {
      ...
      private void afficherEvenements() {
        ...
        calendar.ajouterEvent(new RendezVous(new TitreEvenement(titre), new Proprietaire(userManager.getCurrentUser()), new DateEvenement(LocalDateTime.of(annee, mois, jour, heure, minute)), new DureeEvenement(duree)));
    ...
    private void ajouterReunion() {
        System.out.print("Titre de l'événement : ");
                        ...
                        String participants = userManager.getCurrentUser();
    ...
    private void ajouterEvenementPeriodique() {
        System.out.print("Titre de l'événement : ");
                        ...
                        calendar.ajouterEvent(new EvenementPeriodique(new TitreEvenement(titre3), new Proprietaire(userManager.getCurrentUser()), new DateEvenement(LocalDateTime.of(annee3, moisRdv3, jourRdv3, heure3, minute3)), new DureeEvenement(0), new FrequenceJours(frequence)));
                        System.out.println("Événement ajouté.");
    }
